...
class Userbot(Client):
    def __init__(self):
        self.one = Client(
            ...
            session_string=str(config.SUPERBAN1),
            no_updates=True,
        )
        self.two = Client(
            name="Superban2",
            api_id=config.API_ID,
            api_hash=config.API_HASH,
            session_string=str(config.SUPERBAN2),
            no_updates=True,
        )
        self.three = Client(
            name="Superban3",
            api_id=config.API_ID,
            api_hash=config.API_HASH,
            session_string=str(config.SUPERBAN3),
            no_updates=True,
        )
        self.four = Client(
            name="Superban4",
            api_id=config.API_ID,
            api_hash=config.API_HASH,
            session_string=str(config.SUPERBAN4),
            no_updates=True,
        )
        self.five = Client(
            name="Superban5",
            api_id=config.API_ID,
            api_hash=config.API_HASH,
            session_string=str(config.SUPERBAN5),
            no_updates=True,
        )
    ...
    async def start(self):
        ...
        if config.SUPERBAN1:
            ...
            try:
                await self.one.join_chat("PhoenixXaupport")
                await self.one.join_chat("Arona_update")
            except:
                pass
            assistants.append(1)
            try:
        ...
        if config.SUPERBAN2:
            ...
            try:
                ...
                await self.two.join_chat("Arona_update")
            except:
                pass
            assistants.append(2)
            try:
        ...
        if config.SUPERBAN3:
            ...
            try:
                ...
                await self.three.join_chat("Arona_update")
            except:
                pass
            assistants.append(3)
            try:
        ...
        if config.SUPERBAN4:
            ...
            try:
                ...
                await self.four.join_chat("Arona_update")
            except:
                pass
            assistants.append(4)
            try:
        ...
        if config.SUPERBAN5:
            ...
            try:
                await self.five.join_chat("PhoenixXsupport")
                await self.five.join_chat("Arona_update")
            except:
                pass
            assistants.append(5)
            try:
